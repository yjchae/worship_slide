                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        _sectionLabel(context, '헌금송'),
                        _OfferingDesignButton(
                          design: offeringDesign,
                          onPressed: onEditOffering,
                        ),
                        const SizedBox(height: 16),
...
/// 디자인 패널의 "헌금송 디자인 등록" 버튼. 등록된 계좌를 한 줄로 보여준다.
class _OfferingDesignButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return OutlinedButton(
      ...
      child: Row(
        children: [
          Icon(Icons.volunteer_activism_outlined, size: 18, color: cs.primary),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
              '헌금송 디자인 등록',
          ...
          Flexible(
            child: Text(
              account.isEmpty ? '계좌 미등록' : account,
              overflow: TextOverflow.ellipsis,
              style: TextStyle(
                color: account.isEmpty ? cs.onSurfaceVariant : cs.primary,
